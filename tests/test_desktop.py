...
class TestDesktopConfig:
    ...
    def test_config_reset(self, tmp_path):
        """测试重置配置"""
        from research_agent.desktop_config import DesktopConfig, DEFAULT_CONFIG
...
class TestDesktopApp:
    ...
    def test_window_state_roundtrip(self, tmp_path):
        """测试窗口状态保存与加载"""
        from research_agent.desktop_app import save_window_state, load_window_state
    ...
    def test_window_state_debounce(self, tmp_path):
        ...
        from research_agent.desktop_app import (
            DesktopApp, get_state_file, save_window_state, load_window_state
        )
...
class TestIntegration:
    ...
    def test_full_config_flow(self, tmp_path):
        """测试完整配置流程"""
        from research_agent.desktop_config import DesktopConfig, get_config, reload_config
